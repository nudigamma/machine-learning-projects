...
def explore_city_data(city_data):
    ...
    pl.title('Distribution of the prices of houses in Boston ')
    pl.legend()
    pl.xlabel('Prices')
    pl.ylabel('Frequency')
    pl.show()
...
def fit_predict_model(city_data):
    ...
    reg = GridSearchCV(regressor,parameters,mse_Scorer);
    #reg = GridSearchCV(regressor,parameters,r2_Scorer);
    ...
    print "Neared Neighbors average :" + str(neighbor_avg)
